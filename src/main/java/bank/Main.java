...
public class Main {
    ...
    static void NevmovenkoMA_lab2() throws CreditAccountException, PaymentAccountException, OfficeBankException, AtmBankException,
        ...
        for (int countBank = 0; countBank < 5; countBank++) {
            ...
            for (int countOffice = 0; countOffice < 3; countOffice++) {
                ...
                for (int countEmployee = 0; countEmployee < 5; countEmployee++) {
                    ...
                    employeeService.create(countEmployee + countOffice + countBank, String.format("Михаил %d", countEmployee + countOffice + countBank),
