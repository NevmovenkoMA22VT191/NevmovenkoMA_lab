...
public class Main {
    static void NevmovenkoMA_lab1() {
        ...
        employeeService.create(1, "Михаил", "Невмовенко", LocalDate.of(2001, 10,
                        11),
        ...
        userService.create(1, "Павел", "Невмовенко", LocalDate.of(1995, 9,
                        2),
                "Разработчик JAVA");
    ...
    static void NevmovenkoMA_lab2() throws  OfficeBankException, AtmBankException,
        ...
        for (int count_bankServices = 0; count_bankServices < 5; count_bankServices++) {
            ...
            for (int count_bankOffices = 0; count_bankOffices < 3; count_bankOffices++) {
                ...
                for (int count_employees = 0; count_employees < 5; count_employees++) {
                    EmployeeServiceImpl employeeService = new EmployeeServiceImpl();
                    employeeService.create(count_employees + count_bankOffices + count_bankServices, String.format("Михаил %d", count_employees + count_bankOffices + count_bankServices),
                            "Невмовенко", LocalDate.of(2001, 10, 11), bankService
                                    .getBank(),
            ...
            UserServiceImpl userService = new UserServiceImpl();
            userService.create(count_bankServices, String.format("Павел %d", count_bankServices), "Невмовенко", LocalDate.of(1995,
    ...
    static void NevmovenkoMA_lab3() throws CreditAccountException, PaymentAccountException, OfficeBankException, AtmBankException,
        ...
        for (int count_bankServices = 0; count_bankServices < 5; count_bankServices++) {
            ...
            for (int count_bankOffices = 0; count_bankOffices < 3; count_bankOffices++) {
                ...
                for (int count_employees = 0; count_employees < 5; count_employees++) {
                    EmployeeServiceImpl employeeService = new EmployeeServiceImpl();
                    employeeService.create(count_employees + 5 * count_bankOffices + 3 * count_bankServices, String.format("Михаил %d", count_employees + 5 * count_bankOffices
                                    + 3 * count_bankServices), "Невмовенко",
            ...
            UserServiceImpl userService = new UserServiceImpl();
            userService.create(count_bankServices, String.format("Павел %d", count_bankServices), "Невмовенко", LocalDate.of(1996,
                    9, 2), String.format("Разработчик JAVA %d", count_bankServices));
            for (int count_paymentAccounts = 0; count_paymentAccounts < 2; count_paymentAccounts++) {
                PaymentAccountServiceImpl paymentAccountService = new PaymentAccountServiceImpl();
                paymentAccountService.create(count_paymentAccounts + count_bankServices, userService.getUser(), bankService.getBank());
    ...
    static void NevmovenkoMA_lab4() throws CreditException, PaymentAccountException, OfficeBankException, AtmBankException,
